              ...
              <div className="container-info">
                <div className="accordion">
                  ...
                  <div className="legal-block">
                    ...
                    <button className="acc-header acc-modern" type="button" aria-expanded="false" data-anchor="u-derechos">
                    ...
                    <div className="acc-panel acc-panel--modern" role="region" id="u-derechos">
                    ...
                    <button className="acc-header acc-modern" type="button" aria-expanded="false" data-anchor="u-deberes">
                      <span className="acc-left">
                        <span className="acc-ic">🧩</span>
                        <span className="acc-title">
                    ...
                    <button className="acc-header acc-modern" type="button" aria-expanded="false" data-anchor="u-pqrs">
                      <span className="acc-left">
                        <span className="acc-ic">🧾</span>
                        <span className="acc-title">
                          <strong>PQRS</strong>
                    ...
                    <button className="acc-header acc-modern" type="button" aria-expanded="false" data-anchor="u-calidad">
                      <span className="acc-left">
                        <span className="acc-ic">📶</span>
                        <span className="acc-title">
                    ...
                    <button className="acc-header acc-modern" type="button" aria-expanded="false" data-anchor="u-comp">
                      <span className="acc-left">
                        <span className="acc-ic">💰</span>
                        <span className="acc-title">

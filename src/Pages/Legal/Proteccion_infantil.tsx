                ...
                <div className="accordion">
                  ...
                  <div className="hero-text">
                    <span className="hero-pill">
                      <span className="hero-dot"></span> Seguridad y protección
                    </span>

                    <h1>
                      Protección <span>Infantil.</span>
                    </h1>

                    <p>
                      <strong style={{color: "cadetblue"}}>Super TV Electronic Ltda.</strong>
                      hace parte de la lucha contra la violación de los derechos y dignidad infantil.
                      Damos cumplimiento a la <strong>Ley 679 de 2001</strong> para prevenir y contrarrestar la explotación,
                      pornografía y turismo sexual con menores de edad (Art. 44 Constitución).
                    </p>
